...
export default function DigitalEditorialContentHubProject() {
  const prefersReducedMotion = usePrefersReducedMotion();
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_320px] lg:items-start">
          <div className="min-w-0">
            ...
            <Section
              id="hub"
              title="Hub System"
              subtitle="Select an area for details."
            ...
            <Section
              id="workflow"
              title="Workflow"
              subtitle="A structured path from brief to publish."
              contentClassName="mt-8"
            >
            ...
            <Section
              id="governance"
              title="Governance"
              subtitle="Standards that keep the hub consistent."
              contentClassName="mt-8"
            >
