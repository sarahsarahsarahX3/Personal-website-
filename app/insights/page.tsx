    ...
    return (
        <main className="min-h-screen pt-24 md:pt-32 pb-40 px-6">
            <div className="container mx-auto">
                <header className="mb-4 md:mb-1">
                    <h1 className="text-5xl sm:text-6xl md:text-7xl font-display mb-2 md:mb-0 animate-fade-in-up">
                        Articles
                    </h1>
                </header>
                ...
                <ArticleList
                    ...
                    subtitle="Explore my published articles across brand and editorial platforms."
                />
            </div>
        </main>
    );
