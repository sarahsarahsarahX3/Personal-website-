    ...
    return (
        ...
        >
            <Link
                href={`/work/${slug}`}
                className={cn(
                    "flex w-full flex-col overflow-hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-surface md:grid md:h-full md:grid-rows-[minmax(0,0.82fr)_minmax(0,1.18fr)]",
                    className
                )}
            ...
            >
                ...
                <div className="relative min-h-0 border-t border-white/10 bg-surface/15 p-5 pb-5 md:p-6 md:pb-6">
                    <div className="flex h-full min-h-0 flex-col gap-0">
                        ...
                        <h3
                            className="mt-3 font-display text-[1.35rem] leading-[1.15] text-text-primary/90 transition-colors group-hover:text-text-primary sm:text-[1.5rem] md:text-[1.6rem]"
                            style={{
                                display: "-webkit-box",
                        ...
                        {brand ? (
                            <p className="mt-2 shrink-0 text-[1.12rem] leading-snug tracking-tight text-text-secondary md:text-[1.2rem]">
                                {brand}
                            </p>
                        ) : null}
                        ...
                        {description ? (
                            <p
                                className="mt-3 max-w-[60ch] text-sm leading-[1.55] text-text-secondary"
                                style={{
                                    display: "-webkit-box",
                                    WebkitBoxOrient: "vertical",
                                    WebkitLineClamp: 3,
